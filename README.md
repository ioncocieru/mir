...
- Se joacă în ordinea locurilor. La rândul tău, fie pui o carte
  ...
  **restul cărților rămân pe masă** pentru runda următoare (ex: dacă
  sunt 6 pe masă și iei 4, rămân primele 2 pe masă).
- **Careu (4 cărți identice)**: dacă ai la tine toate cele 4 cărți de
  același fel (ex: toți cei 4 popi), **nu le poți arunca** — le
  păstrezi. Când îți vine rândul și careul respectă regula obișnuită
  (egal sau mai mare decât ultima carte de pe masă), poți apăsa
  **„🃏 Pune careul"** ca să le pui pe toate 4 deodată, și, opțional,
  să mai adaugi **o carte mai mare pe deasupra** din mână, tot în
  aceeași mutare.
...
- **Verificare/acuzație**: butonul „🔍 Verifică" apare doar pe cineva
  care chiar a declarat „Am terminat" (sau a terminat de-adevăratelea) —
  amenda se aplică **o singură dată** per declarație:
  - dacă cel verificat chiar mai avea cărți ascunse → e prins cu
    minciuna, primește imediat **6 cărți penalizare**, iar declarația
    lui e „consumată" (nu se mai poate aplica amendă a doua oară pentru
    aceeași minciună);
